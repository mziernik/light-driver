...
import http.websocket.handshake.HandshakeImpl1Client;
import http.websocket.handshake.HandshakeImpl1Server;
...
public abstract class Draft {
    ...
    public static String readStringLine(ByteBuffer buf) {
        ...
        return b == null ? null
                : Charsetfunctions.stringAscii(b.array(), 0, b.limit());
    }
