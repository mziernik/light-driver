...
import http.websocket.WebSocket.Role;
...
import http.websocket.util.Base64;
...
public class Draft_10 extends Draft {
    ...
    public ByteBuffer createBinaryFrame(Framedata framedata) {
        ...
        int sizebytes = mes.remaining() <= 125 ? 1 : mes.remaining() <= 65535
                ? 2 : 8;
        ByteBuffer buf = ByteBuffer.allocate(1 + (sizebytes > 1 ? sizebytes + 1
                : sizebytes) + (mask ? 4 : 0) + mes.remaining());
