...
public final class SerialPortEvent extends EventObject {
    ...
    /**
     * Constructs a {@link SerialPortEvent} object corresponding to the
     * specified serial event type.
     * <p>
     * This constructor should only be used when the {@link SerialPortEvent}
     * does not contain any data bytes.
     * <p>
     ...
     * <p>
     * Note that event-based write callbacks are only supported on Windows
     * operating systems. As such, the
     * {@link SerialPort#LISTENING_EVENT_DATA_WRITTEN} event will never be
     * called on a non-Windows system.
     *
     * @param comPort The {@link SerialPort} about which this object is being
     * created.
     * @param serialEventType The type of serial port event that this object
     * describes.
    ...
    /**
     * Constructs a {@link SerialPortEvent} object corresponding to the
     * specified serial event type and containing the passed-in data bytes.
     * <p>
     * Valid serial event types are:
     * <p>
     * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{@link SerialPort#LISTENING_EVENT_DATA_AVAILABLE}<br>
    ...
    public final SerialPort getSerialPort() {
        return (SerialPort) source;
    }

    /**
     * Returns the type of serial port event that caused this object to be
     * created.
     * <p>
     ...
     *
     * @return Any data bytes associated with this serial port event or null if
     * none exist.
     */
